...
class ProductPageFrutas extends StatelessWidget{
        ...
        builder: (context,Box<ProductList> box,_){
          return ListView.builder(
            ...
            itemBuilder: (context,index){
                ...
                children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Text(prod.title,style: TextStyle(color: Colors.purple,fontSize: 34,),),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('\$'+prod.price.toString(), style: TextStyle(color: Colors.purple, fontSize: 18),),
                              Text('  /  ', style: TextStyle(color: Colors.purple, fontSize: 18),),
                              Text(prod.category, style: TextStyle(color: Colors.purple, fontSize: 18),),
                            ],
                          ),
                            ...
                            children: [
                              RatingBar(
                                ...
                                ratingWidget: RatingWidget(
                                  ...
                                  half: Icon(Icons.star_half,color: Colors.purple,size: 5,),
                                  empty: Icon(Icons.star_border,color: Colors.purple,size: 5,),
                                ),
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text('Capacity',style: TextStyle(color: Colors.purple,fontSize: 18),),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('Calories',style: TextStyle(color: Colors.purple,fontSize: 18),),
                                Text(prod.calories,style: TextStyle(color: Colors.purple,fontSize: 18),)
                            ],)
                          ),
                          SizedBox(width: 20,),
                          Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('Vitamins',style: TextStyle(color: Colors.purple,fontSize: 18),),
                                Text(prod.vitamins,style: TextStyle(color: Colors.purple,fontSize: 18),)
                            ],)
                          ),
                          SizedBox(width: 20,),
                          Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('Additives',style: TextStyle(color: Colors.purple,fontSize: 18),),
                                Text(prod.aditives,style: TextStyle(color: Colors.purple,fontSize: 18),)
                            ],)
                          )
                        ],
                      )
              ...
              visible:(prod!.category.toLowerCase() == 'frutas'),);
            },
          );
        },
      ),
